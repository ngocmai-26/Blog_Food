  ...
  return (
    <footer className="home-footer">
        ...
        <div className="home-links-container">
          <div className="home-container30">
            <div className="home-product-container">
              <span className="home-footer-title">Product</span>
              <a href="" className="home-footer-text">
                Features
              </a>
              <a href="" className="home-footer-text">
                Pricing
          ...
          <div className="home-container31">
            <div className="home-contact">
              <span className="home-footer-title">Contact Us</span>
              <a href="" className="home-footer-text">
                hello@teleporthq.io
              </a>
            </div>
            <div className="home-socials">
              ...
              <div className="home-icon-group5">
                <a href="">
                  <svg
      ...
      <span className="home-text89">
        ...
        <span className="home-text91"></span>
        <span></span>
      </span>
    </footer>
  );
