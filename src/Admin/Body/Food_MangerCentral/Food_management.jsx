      ...
      <div className="MuiBoxItemBody">
        <div className="MuiBoxItem_Left MuiBoxStudent">
          <div className="MuiBox_Button">
            <div className="row">
              <div className="col-9">
                <Link to="/formCentral" className="btnCreate">
                  Thêm
                </Link>
                  ...
                  {food_centrals.map((item, key) => (
                    <tr className="demo-list" id="demo_list" key={key}>
                      ...
                      <Link to="/chitiet" onClick={() => onClickItem(item)}>
                        ...
                        <button className="btnDelete btnAdmin"  onClick={() =>onDeleteItemFoodC(item.id)}>Xóa</button>
                        <Link
                          to="/editCentral"
                          className=""
...
export default Food_MangerCentral;
